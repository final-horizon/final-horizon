...
namespace Content.Shared.Movement.Components
{
    ...
    public sealed partial class MovementSpeedModifierComponent : Component
    {
        ...
        // friction
        public const float DefaultAcceleration = 13f; // FH
        public const float DefaultFriction = 2f; // FH
        public const float DefaultFrictionNoInput = 2f; // FH
        public const float DefaultMinimumFrictionSpeed = 0.005f;

        // movement
        public const float DefaultBaseWalkSpeed = 2.0f; // FH
        public const float DefaultBaseSprintSpeed = 2.7f; // FH
